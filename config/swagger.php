...
return [
    ...
    |
    */
    "title" => env("SWAGGER_TITLE", "BW Capital Api Documentation"),
    ...
    |
    */
    "description" => env("SWAGGER_DESCRIPTION", "BW Capital API for Saleforce CRM"),
    ...
    |
    */
    "email" => env("SWAGGER_EMAIL", "nazir.h@brande.ae"),
